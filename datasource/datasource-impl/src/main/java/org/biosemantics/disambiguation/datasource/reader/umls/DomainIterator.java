...
public class DomainIterator implements Iterator<ConceptDetail> {
	...
	private Map<String, Concept> allDomains = new HashMap<String, Concept>();

	public DomainIterator(Concept defaultDomain) {
		this.defaultDomain = defaultDomain;
	}

	public enum UmlsDomain {
		AIR("AI/RHEUM, 1993"), ALT("Alternative Billing Concepts, 2009"), AOD("	Alcohol and Other Drug Thesaurus, 2000"), AOT(
				...
				"COSTAR, 1989-1995"), CPM("Medical Entities Dictionary, 2003"), CPT(
				"Current Procedural Terminology, 2010"), CPTSP(
				...
				"German translation of UMDNS, 1996"), DSM3R("DSM-III-R, 1987"), DSM4("DSM-IV, 1994"), DXP(
				"DXplain, 1994"), FMA("Foundational Model of Anatomy Ontology, 2_0"), GO("Gene Ontology, 2009_04_01"), GS(
				...
				"HCPCS Version of Current Procedural Terminology (CPT), 2010"), HHC(
				"Home Health Care Classification, 2003"), HL7V2_5("HL7 Vocabulary Version 2.5, 2003_08_30"), HL7V3_0(
				"HL7 Vocabulary Version 3.0, 2006_05"), HLREL(
				...
				"	Library of Congress Subject Headings, 1990"), LNC(
				"Logical Observation Identifier Names and Codes, 229"), LNC_BRADEN(
				...
				"Outcome and Assessment Information Set, 229_2002"), LNC_PHQ_9(
				"	Patient Health Questionnaire, 229_1999"), LNC_RHO("	Routine Health Outcomes Ltd. (RHO), 229_2008"), LNC_WHO(
				...
				"Russian Translation of MeSH, 2010"), MSHSCR(
				"Croatian translation of the Medical Subject Headings, 2010"), MSHSPA(
				...
				"Quick Medical Reference (QMR), 1996"), RAM(
				"QMR clinically related terms from Randolph A. Miller, 1999"), RCD(
		...
		private UmlsDomain(String officialName) {
	...
	public void init() {
		Collection<ConceptDetail> domainConcepts = new ArrayList<ConceptDetail>();
		for (UmlsDomain domain : UmlsDomain.values()) {
			String labelText = domain.getOfficialName();
			LabelImpl labelImpl = new LabelImpl(labelText, Language.EN);
			NotationImpl notationImpl = new NotationImpl(defaultDomain, domain.name());
			...
			allDomains.put(domain.name(), conceptImpl);
			domainConcepts.add(new ConceptDetailImpl(ConceptType.DOMAIN, conceptImpl));
	...
	public Concept getDomainByNotationCode(String code) {
		return allDomains.get(code);
	}
