...
public abstract class TestUtility {
	...
	public static final ConceptImpl createFullConcept() {
		...
		ConceptLabelImpl label3 = new ConceptLabelImpl(Language.ES, "espanol", LabelType.ALTERNATE);
		...
		NoteImpl definition = new NoteImpl(NoteType.DEFINITION, Language.EN, "some definition");
		NoteImpl change = new NoteImpl(NoteType.CHANGE_NOTE, Language.EN, "created concept");
