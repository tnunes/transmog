...
public class GenderImpl implements AttributeExtractorService {

	private List<Pattern> patterns;

	public GenderImpl(String regexFile) throws FileNotFoundException, IOException {
	...
	public List<Annotation> getAnnotations(String text, int sentenceNumber) {
		...
		for (Pattern pattern : patterns) {
			...
			while (matcher.find()) {
				Annotation annotation = new Annotation(AnnotationTypeConstant.SUBJECT_GENDER, matcher.start(),
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		GenderImpl sizeImpl = new GenderImpl(
				"/Users/bhsingh/code/git/eviped/eviped-tools/src/main/resources/gender.properties");
		List<String> strings = annotationReaderImpl.getAnnotationTextByType("Subject_Gender");
